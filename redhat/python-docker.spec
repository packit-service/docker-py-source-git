...
# rebase-helper strips patch metadata, need to do apply & commit instead
# https://github.com/rebase-helper/rebase-helper/issues/566
git apply %{patches}
git commit -a -q -m "all patches applied"
%endif
